...
Okay just kidding, it's not *really* a new me.

This is my first post on this new site, which I put together using [Github Pages](https://docs.github.com/en/pages), a [Jekyll](https://github.com/jekyll/jekyll) template called [Minimal Mistakes](https://github.com/mmistakes/minimal-mistakes), and a whole lot of patience. Honestly it's kinda here as a test post, but I figured I'd write a bit about the rationale behind this whole thing.

## So why a new site now?

I've been thinking about how I wanted a place to post long-form thoughts about subjects (probably mostly about media, art, and video games) for a while now. First I was exploring [Neocities](https://neocities.org/) as a possibility, but frankly I found it to be a little too janky to be sustainable as a website I actually use for any period of time. It's fun for making a little hobby site, but the idea of fighting the raw HTML to put my professional work on there in a way that could be easily displayed was...way too much effort.
